	...
	<div class="span12">
		...
		<div class="control-group">
				<label class="control-label">
					<?php echo $form->textField($model,'phone_title',array('maxlength'=>13,'class'=>'span2','id'=>'indexPhoneLabel')); ?>
			   </label>
				<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">
				<?php echo $form->textField($model,'email_title',array('maxlength'=>13,'class'=>'span2','id'=>'indexEmailLabel')); ?>
			</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">
				<?php echo $form->textField($model,'address_title',array('maxlength'=>13,'class'=>'span2','id'=>'indexDirectionsLabel')); ?>
			</label>
			<div class="controls">
