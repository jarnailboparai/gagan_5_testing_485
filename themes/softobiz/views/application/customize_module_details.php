...
//        $content_arr = array('about_us', 'location', 'opening_hours', 'testimonials', 'contact_us');
        ...
        <fieldset >
                ...
                <script>
                    ...
                    $(document).ready(function() {
                        ...
                        $('#showMobile').click(function() {
                            ...
                            var URL = '<?php echo Yii::app()->getBaseUrl(true) ?>/index.php?r=application/mytest';
                            $.ajax({
                                type: 'POST',
                                async: false,
                                url: URL,
            ...
            <?php } ?>
            <?php if (in_array(substr($model->name, 0, 7), $content)) { ?>
                <?php
                $cnt_nav = '';
                $cnt_blk = '';
...
//                    $cnt_nav .= '<div class="content_navigation_link"><h3><a href="#article' . $i . '">Article ' . $i . '</a></h3></div>';
            ...
            <div class="form-actions">
                ...
                <?php echo CHtml::submitButton('Save & Reload', array('class' => 'btn btn-primary btn-large on_save', 'style' => 'float: left;margin-left: 35%;')); ?>
