                    ...
                    <?php if ($m['app_type'] == 1) {
                        ...
                        <tr <?php if ($i % 2 == 0) echo 'style="background-color:#eeeeee;"'; ?> >
                            ...
                            <td><a href="<?php echo Yii::app()->createUrl('/application/details', array('app_id' => $m['id'])); ?>" ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/edit-button.png" width="66" height="28" /></a>
                                ...
                                <a href="javascript:void(0);" onclick="delete_app('<?php echo Yii::app()->createUrl('/application/delete', array('app_id' => $m['id'])); ?>');"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/delete-button.png" width="87" height="28" /></a>
                            </td>
                        </tr>
                    <?php } ?>
                    <?php
...
<?php $del_url = Yii::app()->createUrl('/application/delete', array('app_id' => $m['id']));
?>
