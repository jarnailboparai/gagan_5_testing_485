<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<?php $listAccounts		= CHtml::listData($dropdown,'id','title'); ?>
		<?php echo $form->labelEx($model,'application_id'); ?>
		<?php echo $form->dropDownList($model,'application_id',$listAccounts,array('empty'=>'Select App','disabled'=>"disabled")); ?>
