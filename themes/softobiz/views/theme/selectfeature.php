...
<script type="text/javascript"  src="<?= $url ?>/js/jcarousellitefeature.js"></script>
<script> 
       ...
       <div class="carousel main">
          <span id="prev">Prev</span>
            <div class="jCarouselLite">
                <ul>
                	<?php  $i = 0; foreach($modulefiles as $modulefile){ 	?>
                    <?php $str = '<li id="feature_%s"><span class="features">%s</span></li>'  ?>
           			<?php printf($str,$i,$modulefile->title);  $i++; } //echo $modulefile->title; }  ?>                       
                </ul><?php //die;?>
            </div>
