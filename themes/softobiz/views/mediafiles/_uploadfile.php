...
<!--  		<div id="queue" class="align-center"></div>  -->
		...
		<button class="btn btn-success btn-large done_btn" type="button" id="formIdSubmitPhoto">Done</button>
	...
	<script>
	var liTemplate = '<li class="span3" onclick="liUpdateSelectImageMedia(this);">';
		...
		$(function() {
			$('#file_upload').uploadifive({
				...
				'onUploadComplete' : function(file, data) { 
										...
										$("#medialistImageUpload").append(liNew);
									 }
			});
		});
	</script>
