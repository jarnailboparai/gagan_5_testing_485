...
<!--  		<div id="queue" class="align-center"></div>  -->
		...
		<button class="btn btn-success btn-large done_btn" type="button" id="thumbdonesubpage">Done</button>
	...
	<script type="text/javascript">
		...
		jQuery(document).ready(function(){
			...
			jQuery('#thumbdonesubpage').on('click',function(){
				...
				//console.log(jQuery('#SubModules_tab_icon').val(idFiles[1]));
				
				console.log(jQuery('#SubModules_tab_icon').val($(window.imageThumbUrl).find("img:first").attr('src')));
