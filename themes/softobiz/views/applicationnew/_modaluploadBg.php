...
<!-- Modal -->
<div id="myModalMediaImageBg" class="modal hide fade custom_modal tab_gallery" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<button type="button" class="btn btn-primary " style="margin-left:10px;" onclick="openCloseMediaImageBg()" >Add more</button>
</h3>
