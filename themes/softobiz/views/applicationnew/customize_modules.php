...
<?php echo CHtml::submitButton('Save & Continue', array('class' => 'btn btn-primary btn-large', 'style' => 'margin-top:40px')); ?>
            ...
            <div class="control-group" style="display: none;" >
                ...
                <div class="controls">
<?php echo $form->textField($application_model, 'master_keyword', array('class' => 'span5', 'placeholder' => 'Enter A Master Keyword (Optional)', 'id' => 'masterKeyword','value'=>'dd')); ?>
                </div>
            </div>
            ...
            <div class="control-group" style="display: none;" >
                ...
                <div class="controls">
<?php echo $form->textField($application_model, 'master_address', array('class' => 'span5', 'placeholder' => 'Enter A Master Street Address (Optional)', 'id' => 'masterAddress','value'=>'as')); ?>
                </div>
            </div>
