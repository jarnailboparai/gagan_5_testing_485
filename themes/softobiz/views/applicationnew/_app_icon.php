<span class="icon_wrapper">
          <table cellpadding="0" cellspacing="0" class="pull-left app_info_select">        
                   <tr><td><span class="change_icon_block_image_wrapper" style="display:none;"><img src="<?php Yii::getPathOfAlias('webroot'); ?>images/icons-png/icons_communication_1092.png" /></span></td>
                   <td>
...
function liUpdateSelectIconMedia(arg)
	{
		...
		{	
			...
			/*$('img#appicon1').on("click",function() {
				//alert(selected_icon_url);
				//var a = $('li img:first-of-type').attr('src');
			   $('.selected_icon_block_image_wrapper img').attr('src', $(this).attr('src'));  //$(this).attr('src')
			   //alert($(this).attr('src'));
			});*/
