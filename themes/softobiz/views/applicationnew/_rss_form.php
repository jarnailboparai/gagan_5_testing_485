...
<div class="row-fluid manage_apps media_gallery tab_gallery location_form rss_form">
     <?php
        $form = $this->beginWidget('CActiveForm', array(
            'id' => 'module-form-rss',
        	'action'=> CHtml::normalizeUrl(array("tutorial/rss","module_id"=>$model->id)),
...
<!--              		<textarea name="" cols="" rows="" placeholder="Enter Address"></textarea> -->
             		 <input placeholder="Rss Feed Url" id="rss_feed_url" type="textbox"  name="Module[rss_feed_url]"  value="<?= $rss_feed_url; ?>" > 
             		 <br>
