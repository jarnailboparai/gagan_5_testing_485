...
//      $content_arr = array('about_us', 'location', 'opening_hours', 'testimonials', 'contact_us');
        ...
        <fieldset >
            ...
            <?php if (in_array($model->name, $photos_arrsub)) { ?>
                <div class="control-group">
            ...
            <?php if (in_array($model->name, $video)) { ?>
                <div class="control-group">
            ...
            <?php if (in_array($model->name, $keyword_arr)) { ?>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->textField($model, 'keyword', array('class' => 'span12')); ?>
                    </div>
                </div>
            <?php } ?>
            ...
            <?php if (in_array($model->name, $rss_arr)) { ?>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->textField($model, 'rss_feed_url', array('class' => 'span12')); ?>
                    </div>
                </div>
            <?php } ?>
            ...
            <?php if (in_array($model->name, $web_page_arr)) { ?>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->textField($model, 'web_page_url', array('class' => 'span12')); ?>
...
//                    $cnt_nav .= '<div class="content_navigation_link"><h3><a href="#article' . $i . '">Article ' . $i . '</a></h3></div>';
            ...
            <?php if (!in_array($model->name, $admob)) {
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <?php echo $form->textField($model, 'tab_title', array('class' => 'span12', 'value' => $title)); ?>
    ...
    <div id="customizePreview" style="display: none !important;" >
...
<div id="imageListUpdate" class="tab_gallery_wrapper scroll" >
