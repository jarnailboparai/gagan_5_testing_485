...
class XHeditor extends CWidget
{
	 ...
	 * @var string
	 */
	private $_configurableAttributes = 'id,name,layerShadow,tools,skin,showBlocktag,internalScript,internalStyle,width,height,loadCSS,fullscreen,beforeSetSource,beforeGetSource,focus,blur,forcePtag';
