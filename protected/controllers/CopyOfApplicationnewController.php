				...
				if ($module == 'news(keyword)') {
					...
					foreach($obj->subModules as $sub){
						...
						if($sub->videomedia->type == 1)
						{
							...
							$subMenus .= '<div class="play_video_icon"><img src="images/play_icon.png" /></div><div class="img_title">Paris City</div>';
							$subMenus .= "</div>";
...
// 						$strss .= '</a></li>';
	...
	{
		return 'buildAppMy,buildAppSelectionsMy,buildAppSelections,generateThemeMenu,createFolderRecur,listselectfeatures,customizemoduledetailsnewdesign,delete,customizeSubModuleContent,selectPage,customizeModuleContent,addSelectFeatures,finalPreview,listfeatures,selectfeature,theme,dashboard,mytest,customizemodules,changeAppColor,mytestzip,mytestzipapp,home,details,modules,customizeModules,customizemoduledetailsnew,customizemoduledetails,moduleOrder,splash,finalpreview';
	}
